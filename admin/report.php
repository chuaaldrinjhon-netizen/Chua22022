  ...
  <div class="card-body">
    ...
    <div class="d-flex justify-content-between mb-3">
      ...
      <div class="d-flex gap-2">
        <input type="text" class="form-control" placeholder="Search by name, owner..." style="width: 250px;">
    ...
    <div class="row mb-3">
      ...
      <div class="col-md-3">
        <select class="form-select">
          <option>Sort by: Updated (New)</option>
          <option>Updated (Old)</option>
        </select>
      </div>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-bordered align-middle">
        ...
        <tbody>
          ...
          <?php
          $query = "SELECT * FROM reports"; // gawa ka table reports
          ...
          <tr>
            <td>
              <strong><?= $row['report_name'] ?></strong><br>
            ...
            <td>
              <?php
                if($row['status'] == "Published"){
                  ...
                  echo '<span class="badge bg-dark">Archived</span>';
                }
              ?>
            </td>
