        ...
        <div class="authentication-inner py-6 mx-4">
          ...
          <div class="card p-sm-7 p-2">
            ...
            <div class="card-body mt-1">
              ...
              <form id="formAuthentication" class="mb-5" action="admin/register.php" method="POST">
                ...
                <div class="form-floating form-floating-outline mb-5 form-control-validation">
                  <input type="text" class="form-control" id="role" name="role" placeholder="Role (admin/user)" />
                ...
                <button class="btn btn-primary d-grid w-100 mb-5" type="submit" name="register" value="Register">Sign up</button>
              </form>
