                  ...
                  <div class="card">
                    <div class="card-body">
                      <form action="edit.php" method="POST">
                        ...
                        <div class="row mb-4">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Student Number</label>
                          <div class="col-sm-10">
                            <input type="number" value="<?=$row['student_number'];?>" readonly
                            name="snumber" class="form-control" id="basic-default-name" placeholder="John Doe" />
                          </div>
                        </div>
                        <div class="row mb-4">
                          ...
                          <div class="col-sm-10">
                            ...
                            name="lastname" class="form-control" id="basic-default-name" placeholder="John Doe" />
                          </div>
                        </div>
                        <div class="row mb-4">
                          ...
                          <div class="col-sm-10">
                            ...
                            name="firstname" class="form-control" id="basic-default-name" placeholder="John Doe" />
                          </div>
                        </div>
                        <div class="row mb-4">
                      ...
                      <?php
                        ...
                        echo "<script> alert('Something Went Wrong! NO ID FOUND');
